...
public class TrainStations {
	...
	public TrainStations(int x, int y, String title) {
...
//			}
	...
	private void initialize(int x, int y, String title) {
		...
		background.setIcon(new ImageIcon(TrainStations.class.getResource("/quarterMap.png")));
		...
		fountain1.setIcon(new ImageIcon(TrainStations.class.getResource("/fountain.gif")));
		fountain1.setBounds(255, 252, 63, 64);
		graphicalPanel.add(fountain1);
		
		JLabel fountain2 = new JLabel("");
		fountain2.setIcon(new ImageIcon(TrainStations.class.getResource("/fountain.gif")));
		fountain2.setBounds(516, 252, 63, 64);
		graphicalPanel.add(fountain2);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(TrainStations.class.getResource("/biggerEntrance.png")));
		lblNewLabel.setBounds(327, 0, 180, 49);
		graphicalPanel.add(lblNewLabel);
		
		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(TrainStations.class.getResource("/biggerEntrance2.png")));
		label.setBounds(327, 378, 180, 49);
